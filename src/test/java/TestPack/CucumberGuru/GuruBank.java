...
public class GuruBank {
	...
	public void the_user_is_in_guru_bank_home_page() throws Throwable {
		Base.driver.get("http://www.demo.guru99.com/v4/");
	}
	...
	public void the_user_is_logged_in_with_manager_credentials(DataTable credentialsMaps) throws Throwable {
		...
		Base.driver.findElement(By.name("uid")).sendKeys(credentials.get(0).get("mngrid"));
		Base.driver.findElement(By.name("password")).sendKeys(credentials.get(0).get("mngrpwd"));
	...
	public void the_user_enters_numerical_values_in_Customername_City_and_State_fields(DataTable input)
		...
		WebElement txtCustName = Base.driver.findElement(By.name("name"));
		txtCustName.sendKeys(inputNum.get(0));
		WebElement txtCity = Base.driver.findElement(By.name("city"));
		txtCity.sendKeys(inputNum.get(0));
		WebElement txtState = Base.driver.findElement(By.name("state"));
	...
	public void the_user_should_see_error_for_Customername_City_and_State_fields() throws Throwable {
		Assert.assertEquals(Base.driver.findElement(By.xpath("//label[@id='message']")).getText(),
				"Numbers are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.xpath("//label[@id='message4']")).getText(),
				"Numbers are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.xpath("//label[@id='message5']")).getText(),
				"Numbers are not allowed");
	...
	public void the_user_enters_special_charaters_in_Customername_Address_City_State_PIN_and_Mobilenumber_fields(
		...
		Base.driver.findElement(By.name("name")).sendKeys(inputSpl.get(0));
		Base.driver.findElement(By.name("addr")).sendKeys(inputSpl.get(0));
		Base.driver.findElement(By.name("city")).sendKeys(inputSpl.get(0));
		Base.driver.findElement(By.name("state")).sendKeys(inputSpl.get(0));
		Base.driver.findElement(By.name("pinno")).sendKeys(inputSpl.get(0));
		Base.driver.findElement(By.name("telephoneno")).sendKeys(inputSpl.get(0));
	...
	public void the_user_should_see_error_for_Customername_Address_City_State_PIN_and_Mobilenumber_fields()
			throws Throwable {
		Assert.assertEquals(Base.driver.findElement(By.id("message")).getText(), "Special characters are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.id("message3")).getText(), "Special characters are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.id("message4")).getText(), "Special characters are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.id("message5")).getText(), "Special characters are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.id("message6")).getText(), "Special characters are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.id("message7")).getText(), "Special characters are not allowed");
	}
	...
	public void the_user_enters_characters_in_PIN_and_Mobilenumber_fields(DataTable input) throws Throwable {
		...
		Base.driver.findElement(By.name("pinno")).sendKeys(inputChar.get(0));
		Base.driver.findElement(By.name("telephoneno")).sendKeys(inputChar.get(0));
	}
	...
	public void the_user_should_see_error_for_PIN_and_Mobilenumber_fields() throws Throwable {
		Assert.assertEquals(Base.driver.findElement(By.id("message6")).getText(), "Characters are not allowed");
		Assert.assertEquals(Base.driver.findElement(By.id("message7")).getText(), "Characters are not allowed");
	}
	...
	public void the_user_enters_invalid_email_id(DataTable input) throws Throwable {
		...
		Base.driver.findElement(By.name("emailid")).sendKeys(inputEmail.get(0));

	}

	@Then("^The user should see error for email field$")
	public void the_user_should_see_error_for_email_field() throws Throwable {
		Assert.assertEquals(Base.driver.findElement(By.id("message9")).getText(), "Email-ID is not valid");
	}
	...
	public void the_user_clicks_reset_button_after_entering_all_inputs(DataTable input) throws Throwable {
		...
		Base.driver.findElement(By.name("name")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("addr")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("city")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("state")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("pinno")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("telephoneno")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("emailid")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("password")).sendKeys(inputReset.get(0));
		Base.driver.findElement(By.name("res")).click();
	}

	@Then("^The user should see all fields cleared$")
	public void the_user_should_see_all_fields_cleared() throws Throwable {
		Assert.assertEquals(Base.driver.findElement(By.name("name")).getAttribute("value"), "");
	...
	public void the_user_enters_and(String custname, String gender, String dob, String address, String city,
		...
		Base.driver.findElement(By.name("name")).sendKeys(custname);
		if (gender.equals("male")) {
			Base.driver.findElement(By.xpath("//input[@type='radio' and @value='m']")).click();
		} else if (gender.equals("female")) {
			Base.driver.findElement(By.xpath("//input[@type='radio' and @value='f']")).click();
		}
		...
		Base.driver.findElement(By.name("telephoneno")).sendKeys(phno);
	...
	public void the_user_should_see_success_message_with_customer_id_created() throws Throwable {
		Assert.assertTrue(Base.driver.getCurrentUrl().contains("Customer"));
		Assert.assertTrue(
				Base.driver.findElement(By.xpath("//p[contains(text(),'Registered')]")).getText().contains("Successfully"));
		List<WebElement> tRows = Base.driver.findElements(By.tagName("tr"));
	...
	public void the_user_navigates_to_Edit_customer_page() throws Throwable {
		//Base.driver.findElement(By.xpath("//a[text()='Edit Customer']")).click();
		Base.goToPage("Edit Customer");
	}

	@When("^The user enters characters$")
	public void the_user_submits_after_entering_characters(DataTable input) throws Throwable {
		List<String> inputChar = input.asList(String.class);
		Base.driver.findElement(By.name("cusid")).sendKeys(inputChar.get(0));
	}
	...
	public void the_user_should_see_error_in_Edit_customer_page() throws Throwable {
		Assert.assertTrue(Base.driver.findElement(By.id("message14")).getText().contains("not allowed"));
	...
	public void the_user_submits_after_entering_special_characters(DataTable input) throws Throwable {
		...
		Base.driver.findElement(By.name("cusid")).sendKeys(inputSplChar.get(0));
	}
	...
	public void the_user_submits_after_entering_invalid_customer_id(DataTable input) throws Throwable {
		...
		Base.driver.findElement(By.name("cusid")).sendKeys(inpInvalid.get(0));
		Base.driver.findElement(By.name("AccSubmit")).click();
	...
	public void the_user_should_see_customer_id_field_cleared() throws Throwable {
		Assert.assertEquals("", Base.driver.findElement(By.name("cusid")).getAttribute("value"));
	...
	public void the_user_submits_after_entering_valid_customer_id(DataTable input) throws Throwable {
		...
		Base.driver.findElement(By.name("cusid")).sendKeys(inpValid.get(0));
		Base.driver.findElement(By.name("AccSubmit")).click();
	...
	public void the_user_submits_after_making_any_modification(DataTable input) throws Throwable {
		List<String> inpValid = input.asList(String.class);
		Base.driver.findElement(By.name("addr")).sendKeys(inpValid.get(0));
		Base.driver.findElement(By.name("sub")).click();
	...
	public void the_user_should_see_success_message() throws Throwable {
		Assert.assertTrue(Base.driver.findElement(By.xpath("//p[contains(text(),'updated')]")).getText().contains("updated"));
